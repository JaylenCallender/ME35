...
class Puppet:
    def __init__(self):
        ...
        self.mini_motor = servo.Servo(Pin(6)) 
    ...
    def movement(self, msg):
        ...
        print(msg)
        if msg == b'!up':
            self.set_servo_angle(25, self.head)
            time.sleep(1)
            self.set_servo_angle(90, self.head)
            time.sleep(1)
            self.set_servo_angle(90, self.head)
            print("head moves")
            ...
            self.set_servo_angle(100, self.wings)
            time.sleep(1)
            self.set_servo_angle(90, self.wings)
            time.sleep(1)
            self.set_servo_angle(100, self.wings)
            print("wings move")
